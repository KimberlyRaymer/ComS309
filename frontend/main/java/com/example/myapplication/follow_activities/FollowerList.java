...
public class FollowerList extends AppCompatActivity
{
    ...
    //USER WHO OWNS THIS FOLLOWERS LIST
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        getFollowers(users_following);

        ImageButton menu = findViewById(R.id.menuBttn);
        menu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FollowerList.this, MenuActivity.class);
        ...
        backArrow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                Intent intent = new Intent(FollowerList.this, ScrollingActivity.class);
                startActivity(intent);
            }
        });
    }
    ...
    public void getFollowers(String username) {
        RequestQueue queue = Volley.newRequestQueue(FollowerList.this);

        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Request.Method.GET, RecipeConstants.URL_USER_BLANK + username + RecipeConstants.URL_USER_FOLLOWER_CAT, null, new Response.Listener<JSONArray>() {
            @Override
            public void onResponse(JSONArray response) {
                try {
                    ...
                    Toast.makeText(FollowerList.this, "Good", Toast.LENGTH_SHORT).show();

                    if (!userList.isEmpty()) {
                        //creates cardview of listed recipes
                        for (int i = 0; i < userList.size(); i++) {
                            String usrnme = userList.get(i).getUsername();
                            Button bttn = new Button(FollowerList.this);
                            bttn.setText(usrnme);
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(FollowerList.this, "Fail to get response = " + error, Toast.LENGTH_SHORT).show();
            }
        });
